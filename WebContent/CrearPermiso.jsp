...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<div class="w3-row"><br>
		...
		<form action="CrearPermisoServlet">
			
			<p>Nombre: <input type="text"name="nombre"></p>
			<p>Descripción (max 250 caracteres):
			<textarea type="text" name="descripcion" maxlength="250" style="width:400px;height:130px;vertical-align: top;" cols="35" rows="10" wrap="soft"></textarea>
			</p>
