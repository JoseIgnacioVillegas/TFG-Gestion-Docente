...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<h2>EDITAR Plaza de profesor</h2>
	...
	<form action="EditarPlazaServlet">
	<input type="hidden" name="id" value="<%=id%>">
		<p>Nombre de la plaza: <input type="text" name="nombre" value="<%=nom%>"></p>
		<p>Descripción(max 250 caracteres):<textarea type="text" name="descripcion" maxlength="250" style="width:400px;height:130px;vertical-align: top;" cols="35" rows="10" wrap="soft"><%=descripcion%></textarea></p>
