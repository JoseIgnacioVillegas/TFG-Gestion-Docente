	...
	<%@ include file="topbar.jsp" %> 
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Crear Plan de Estudios</h1>
          </div>
          ...
          <div class="row">
			<div class="col-xl-3 col-md-6 mb-4"></div>
            	...
            	<form class="user"  action="CrearPlanServlet">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="codigo" placeholder="Introduce el código del plan">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" placeholder="Introduce el nombre del plan" name="nombre">
                    </div>
