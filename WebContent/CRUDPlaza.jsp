...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<div class="w3-row"><br>
		...
		<form action="CrearPlaza.jsp">Para crear una nueva plaza de profesor pincha aquí: <button type="submit" >Crear una plaza nueva</button></form>		
		<br>
		<br>
...
<table id="datos" style="margin: 0 auto;text-align: left;">
	<tr>
		...
		<td><form action="EditarPlaza.jsp">
			...
			<td><form action="BorrarPlazaServlet">
			<input type="hidden" value="${plaza.id}" name="id">
