...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<h2>Gestionar Plan de estudios</h2>
	...
	<div class="w3-row"><br>
		...
		<form action="CrearPlan.jsp">Para crear un nuevo plan de estudios pincha aquí: <button type="submit" >Crear un nuevo plan</button></form>		
		<br>
		<br>
