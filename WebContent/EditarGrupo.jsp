...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<h2>EDITAR Grupo de profesores</h2>



  <form action="EditarGrupoServlet">
    <input type="hidden" value="<%=nom%>" name="nombre1">
    <p>Nombre del grupo: <input type="text"name="nombre" value="<%=nom%>"></p>
    <p>Acrónimo del grupo: <input type="text"name="acronimo" value="<%=acron%>"></p>
