...
<div class="w3-container w3-padding-64 w3-center" id="team">
	...
	<div class="w3-row"><br>
		...
		<form action="CrearPermiso.jsp">Para crear un nuevo permiso haz click aqui : <button type="submit" >crear permiso</button></form>		
		<br>
		<br>
	...
	<tr>
		...
		<td><a>Editar permiso</a></td>
		<td><a>Borrar permiso</a></td>
	</tr>
		...
		<tr>
			...
			<td><p title="${permiso.descripcion}" style="height:20px;width:200px; overflow:hidden!important;">${permiso.descripcion}</p></td>

			
			<td><form action="EditarPermiso.jsp">
				<input type="hidden" value="${permiso.permiso}" name="permiso">
				<input type="hidden" value="${permiso.descripcion}" name="descripcion">
				<input type="hidden" value="${permiso.id}" name="id">
			<button type="submit" >Editar</button></form></td>
			
			
			<td><form action="BorrarPermisoServlet">
			<input type="hidden" value="${permiso.id}" name="id">
