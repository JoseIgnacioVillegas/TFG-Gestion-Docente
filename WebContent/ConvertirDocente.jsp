        ...
        <div class="container-fluid">
          ...
          <div class="row">
			<div class="col-xl-3 col-md-6 mb-4"></div>
            	...
            	<form class="user"  action="ConvertirProfesorServlet">
            	<input type="hidden"  name="id" value="${usuario.id}" >
                    <div class="form-group"><input type="text" class="form-control form-control-user" name="nombre" value="${usuario.nombre}" readonly></div>
                    <div class="form-group"><input type="text" class="form-control form-control-user" name="apellidos" value="${usuario.apellidos}" readonly></div>
                    ...
                    <div class="form-group"><input type="text" class="form-control form-control-user" name="correo" value="${usuario.correo}" readonly></div>                 
					...
					<br>
                     ...
                     <button type="submit" class="btn btn-primary btn-user btn-block">Convertir</button>
